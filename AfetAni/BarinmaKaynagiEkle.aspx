<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BarinmaKaynagiEkle.aspx.cs" Inherits="AfetAni_BarinmaKaynagiEkle" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:SqlDataSource ID="SQLDS_Barinma" runat="server" ConnectionString='<%$ ConnectionStrings:AFET_YONETIMConnectionStringMSSQL %>' SelectCommand="SELECT * FROM [BARINMA_KAYNAKLARI]" InsertCommand="INSERT INTO [BARINMA_KAYNAKLARI] ([bulundugu_kurum], [kapasite], [harita_konum], [adres], [barinma_kaynak_turu]) VALUES (@bulundugu_kurum, @kapasite, @harita_konum, @adres, @barinma_kaynak_turu)">
        <InsertParameters>
            ...
            <asp:ControlParameter ControlID="DdlBarinmaKaynakTurleri" Name="barinma_kaynak_turu" PropertyName="SelectedValue" Type="Int32" />
        </InsertParameters>
        </asp:SqlDataSource>
    ...
    <div class="col s9 m9 l9">
        <div class="card white">
            <div class="card-content">
                <span class="card-title">Yeni Barınma Kaynağı Ekle</span>
                <div class="row">
                    <div class="input-field col s6">
                        <asp:DropDownList ID="DdlBarinmaKaynakTurleri" runat="server" DataSourceID="SQLDS_BarinmaKaynakTurleri" DataTextField="barinma_kaynak_turu_adi" DataValueField="id"></asp:DropDownList>
                        <label for="DdlOlayTurleri">Barınma Kaynağı Türü</label>
                    </div>
                    <div class="input-field col s6">
                ...
                <div class="row">
                    <div class="input-field col s6">
                        ...
                        <label for="TxtAdres">Barınma Adresi</label>
                    </div>
                </div>
                <div class="row">
                    <div class="col s12 right-align">
                        ...
                        <asp:HyperLink ID="BtnIptal" runat="server" CssClass="waves-effect red waves-light btn" NavigateUrl="~/AfetAni/BarinmaKaynakYonetimi.aspx"><i class="material-icons left">not_interested</i>İptal</asp:HyperLink>
                    </div>
                </div>
