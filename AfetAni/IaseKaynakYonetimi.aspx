<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="IaseKaynakYonetimi.aspx.cs" Inherits="IaseKaynakYonetimi" EnableEventValidation="false" %>
...
<div class="col s9 m9 l9">
    ...
    <div class="card-content">
        <span class="card-title">İaşe Kaynakları</span>
        <asp:SqlDataSource ID="SQLDS_Iase" runat="server" ConnectionString='<%$ ConnectionStrings:AFET_YONETIMConnectionStringMSSQL %>' DeleteCommand="DELETE FROM [IASE_KAYNAKLARI] WHERE [id] = @id" SelectCommand="SELECT IASE_KAYNAKLARI.*, KURUMLAR.kurum_adi, Iase_Kaynak_Turleri.iase_kaynak_turu_adi FROM IASE_KAYNAKLARI INNER JOIN Iase_Kaynak_Turleri ON IASE_KAYNAKLARI.iase_kaynak_turu = Iase_Kaynak_Turleri.id INNER JOIN KURUMLAR ON IASE_KAYNAKLARI.bulundugu_kurum = KURUMLAR.id" UpdateCommand="UPDATE [IASE_KAYNAKLARI] SET [bulundugu_kurum] = @bulundugu_kurum, [kapasite] = @kapasite, [harita_konum] = @harita_konum, [adres] = @adres, [iase_kaynak_turu] = @iase_kaynak_turu WHERE [id] = @id">
            <DeleteParameters>
            ...
            <UpdateParameters>
                ...
                <asp:Parameter Name="iase_kaynak_turu" Type="Int32"></asp:Parameter>
                <asp:Parameter Name="id" Type="Int32"></asp:Parameter>
            </UpdateParameters>
        </asp:SqlDataSource>
        ...
        <asp:GridView ID="GridView1" CssClass="striped" runat="server" DataSourceID="SQLDS_Iase" AutoGenerateColumns="False" DataKeyNames="id" OnRowCommand="GridView1_RowCommand">
            <Columns>
                <asp:BoundField DataField="id" HeaderText="#" ReadOnly="True" InsertVisible="False" SortExpression="id"></asp:BoundField>
                <asp:TemplateField HeaderText="Kaynak Türü" SortExpression="iase_kaynak_turu">
                    <EditItemTemplate>
                        <asp:DropDownList ID="DdlIaseKaynakTurleri" runat="server" DataSourceID="SQLDS_IaseKaynakTurleri" DataTextField="iase_kaynak_turu_adi" DataValueField="id" SelectedValue='<%# Bind("iase_kaynak_turu") %>'></asp:DropDownList>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label runat="server" Text='<%# Bind("iase_kaynak_turu_adi") %>' ID="Label3"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
    ...
    <div class="col s12 m12 l12">
        <asp:HyperLink ID="BtnBarinmaKaynagiEkle" runat="server" CssClass="waves-effect waves-light btn right teal" NavigateUrl="~/AfetAni/IaseKaynagiEkle.aspx"><i class="material-icons left">control_point</i>Yeni İaşe Kaynağı</asp:HyperLink>
       </div>
       </div>
</div>
